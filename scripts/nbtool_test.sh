...
IP_NB=labs-terraform-private/tf-intro/10.Revision/IP_TF_Lab10.Revision.ipynb
...
get_SRC_ROOT() {
    ...
    case $REF_DIR in
        *src/github.com/GIT_mjbright*)
            ...
            IP_NB=${SRC_ROOT}/${IP_NB}
            ;;

        #*src/) IP_NB=~/src/mjbright.${IP_NB} ;;
        *src/)
            SRC_ROOT=~/src
            IP_NB=${SRC_ROOT}/mjbright.${IP_NB}
            ;;
